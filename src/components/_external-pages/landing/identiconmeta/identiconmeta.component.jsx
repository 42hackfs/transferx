...
import { toChecksumHexAddress } from '../../../../utils/hexstring-utils';
...
export default class IdenticonMeta extends PureComponent {
  static propTypes = {
  ...
  renderBlockie() {
    ...
    return (
      <div className={classnames('identicon', className)} style={getStyles(diameter)}>
  ...
  render() {
    ...
    return <div style={getStyles(diameter)} className="identicon__image-border" />;
  }
}
